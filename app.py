...
def answer_query_with_confidence(user_query, chat_history, threshold=0.5, max_history_turns=10):
    ...
    messages = [
        {"role": "system", "content": "You are a helpful mentor for Butterfly Fields DIY kits. Use manuals when relevant."}
    ]
    ...
    if best_score >= threshold:
        ...
        user_input = f"User query: {user_query}\n\nI didn’t find an exact match in the manuals. Still, try to guide based on related knowledge of kits."
